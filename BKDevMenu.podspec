#
#  Be sure to run `pod spec lint UIFontLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "陆子铮"
  # spec.authors            = { "陆子铮" => "arloou@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/陆子铮"
  ...
  spec.source_files  = "BKDevMenu/src/*.{h,m}"
  # spec.exclude_files = "Classes/Exclude"

  spec.public_header_files = "BKDevMenu/src/*.{h}"
  ...
  spec.default_subspecs = 'privateClass','sandbox','console'
